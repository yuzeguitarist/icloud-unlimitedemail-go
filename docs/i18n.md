...
### 方法一：通过配置文件设置 / Method 1: Set via Config File
...
### 方法二：通过软件设置菜单 / Method 2: Set via Software Menu

1. 启动程序 / Start the program
2. 选择 `[8] 程序设置` / Select `[8] Program Settings`
3. 选择 `[4] 语言设置` / Select `[4] Language Settings`
4. 选择你想要的语言 / Select your desired language:
   - `[1]` 中文 (Chinese)
   - `[2]` English
   - `[3]` Deutsch (German)
5. 语言会立即切换，并自动保存到配置文件 / Language switches immediately and saves to config file automatically
